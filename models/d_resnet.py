# This is the implementation of ResNet-18 with a projection layer
...
# If you do not have a GPU for training, please disable it, otherwise, there would be an error.
parser.add_argument('--data', metavar='DIR', default='..\data\dataset\dataset1',
                    help='path to dataset')
parser.add_argument('--gpu', type=int,
                    help='GPU id to use.')
parser.add_argument('--projection-type', dest='projection_type', type=str, default='L2S',
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # # to run alxenet, comment these two lines below.
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        adjust_learning_rate(optimizer, epoch, args, step=100)
